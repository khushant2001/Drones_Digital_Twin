...
class MavDynamics:
    ...
    def update(self, forces_moments):
        ...
        x_vel.append(self._state[3])
        y_vel.append(self._state[4])
        z_vel.append(self._state[5])
        x_roll.append(self._state[10])
        y_pitch.append(self._state[11])
        z_yaw.append(self._state[12])
